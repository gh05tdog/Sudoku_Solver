...
public class Board {
    ...
    //Makes sure that the number can be placed in the cell, and no duplicates in row, col and subgrid.
    ...
    //The initial board is the board created with some of the numbers filled. This is the restart point for the game.
